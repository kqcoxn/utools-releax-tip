                ...
                <div class="time-card">
                    <div class="time-card-header">
                        ...
                        <div class="time-label">
                            ...
                            <span class="label-value">{{ settingsStore.focusTime }}<span class="unit">分钟</span></span>
                        </div>
                    </div>
                ...
                <div class="time-card">
                    <div class="time-card-header">
                        ...
                        <div class="time-label">
                            ...
                            <span class="label-value">{{ settingsStore.relaxTime }}<span class="unit">分钟</span></span>
                        </div>
                    </div>
                    <div class="time-input-row">
                ...
                <div class="time-card">
                    <div class="time-card-header">
                        ...
                        <div class="time-label">
                            ...
                            <span class="label-value">{{ settingsStore.laterTime }}<span class="unit">分钟</span></span>
                        </div>
                    </div>
                    <div class="time-input-row">
